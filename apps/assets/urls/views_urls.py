...
urlpatterns = [
    ...
    #path('asset/ak/import/', views.CloudImportAssetView.as_view(), name='asset-ak-import'),
    ...
    path('system-user/import/', views.SystemUserImportView.as_view(), name='system-user-import'),
    path('system-user/export/', views.SystemUserExportView.as_view(), name='system-user-export'),
